...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [_625UARROW] = LAYOUT_625u_arrow(
  ...
  KC_LCTL, KC_LGUI, TD(ALT_OSL1),                          KC_SPC,                      MO(1),   KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT \
 ),
 [RAISE] = LAYOUT_625u_arrow(
  KC_GRV,  KC_F1,    KC_F1,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,    KC_F11, KC_F12,  KC_DEL, \
  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_PSCR, KC_SLCK, KC_PAUS, KC_BSLS, \
  KC_CAPSLOCK, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_INS,  KC_HOME, \
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_END, \
  KC_LCTL, KC_LGUI, KC_TRNS,                          RESET,                      MO(1),   KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT \
 )
};
